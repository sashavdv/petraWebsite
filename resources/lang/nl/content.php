...
return [
    ...
    'about' => '<P>
                    ...
                    Haar ouders zetten zich ook als eerste(n) in een kleine dorpsgemeenschap ook in naar sociaal onrecht, haar moeder was erg creatief van natuur en haar vader had een goedlachs standvastig karakter, 
                    waar zijn liefde voor het leven zich voornamelijk uitte in de genegenheid hij voor zijn vrouw en dochter koesterde.
                </P>
                <p>
                    Dat haar ouders hun kerkelijk ambt aan de haak hingen en voor een gezin kozen, zorgde wel altijd voor wat deining in de dorpsgemeenschap en Petra kreeg met veelvuldige pesterijen rond dit stigma te maken. 
                    Het maakte dat ze zich als tiener jarenlang ‘anders’ voelde en geen aansluiting vond. Het maakte echter ook dat haar ontwakingsproces op gang kwam doordat ze van veel zaken al jong de andere kant 
                    van de medaille kon observeren.En het kweekte in kiem, hoe onaangenaam ook op dat eigenste moment, een soort van vertrouwen in zichzelf en haar eigen intuïtie. Het leerde haar anders te kijken.
                </p>
                <p>
    ...
    'face_care' => '
                ...
                <p>In een wereld waar we langs alle kanten overspoeld worden door toxische stoffen, wil ik je op sleeptouw nemen langs een meer natuurlijk pad voor jouw huid.</p>
                <p>De huid van je gelaat en je lichaam.</p>
                <p>Waarom?</p>
                <p><ul>
                    <li>Omdat op een meer zorgzame en verfrissende wijze met jezelf om springen, je blij maakt en krachtig je zelfbeeld ondersteunt.</li>
                    <li>Omdat je zo een verlaging van immuniteitsziekten kan verkrijgen en het veel minder allergische reactie opwekt.</li>
                    <li>Omdat het genetisch gezien beter voor ons allemaal is, en we onszelf én de natuur er een ferme dienst mee doen.</li>
                    <li>Omdat niets zo makkelijk én eenvoudig is, als met natuurlijke producten en degelijke basis ingrediënten te werken of je hiermee te laten verzorgen.</li>
                    <li>Omdat je je verzorgingsproducten zelf zo ondersteunend en activerend voor je huid kan maken als je maar wilt.</li>
                    <li>Omdat natuurlijke geuren iets anders doen met onze hersenen dan gefabriceerde namaak.</li>
                    <li>Omdat het nu eenmaal anders kan, en deze wereld je een speelplein van mogelijkheden geeft, dus waarom zou je jezelf daar niet van bedienen?</li>
                    <li>Omdat alles er al is en bestaat: degelijke verzorgingen met werkelijk natuurlijke ingrediënten!</li>
                </ul></p>
                <p>Elke dag worden we namelijk geconfronteerd met pollutie in de lucht rond ons, met agressieve detergenten en wasproducten, met kleurstoffen en bewaarmiddelen in onze voeding en verzorgingsproducten. 
                Maar daar stopt het niet bij:</p>
                <p>Onze hormonen worden via deze voeding en via de huid bewerkt door deze ‘welvaart’ en welvaartproducten, met als gevolg dat onze natuurlijke immuniteit onder druk staat.</p>
                <p>We spuiten luchtverfrissers in onze huizen, brengen schadelijke deo en synthetisch parfum op onze huid. Dagelijks nog wel.</p>
                <p>Nog nooit kenden we zoveel allergische reacties en intolerantie verschijnselen.</p>
                <p>Maar dat hoeft geen feit te blijven.  En af & toe zondigen tegen de regels van natuurlijkheid in, behoeft geen taboe te zijn. Je kan namelijk kiezen waar je je mee verzorgt. En kleine veranderingen maken wel degelijk een groot verschil.</p>
                <p>Dàt wat je met regelmaat doet of nalaat maakt juist het grootste verschil uit in the long run.</p>
                    Met regelmaat verschijnen er hier op deze website kleine workshops op de kalender, die geen voorkennis vereisen. 
                    Op jouw persoonlijke maat leer je zelf voor je huid te zorgen, op de meest integere manier.
                    Jouw lichaamshuid intiemer en beter leren kennen is een genot, waar je zelf veel plezier aan zal ondervinden.</p>
                   
                <p>Voor meer info kan je me ook volgen op Instagram of Facebook.</p>
